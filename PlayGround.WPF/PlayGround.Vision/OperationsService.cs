...
public interface IOperationsService : IDisposable
{
  ...
  ReactiveCommand<(int sourceId, int destinationId, string sourceFieldName, string destinationFieldName), Unit> Connect { get; }
}
...
public class OperationsService : IOperationsService
{
  ...
  public OperationsService()
  {
    ...
    Connect = ReactiveCommand.Create<(int sourceId, int destinationId, string sourceFieldName, string destinationFieldName)>(tuple =>
    {
      ...
      if (sourceOptional.Value.Outputs.Count < sourcePropertyIndex) return;
      
      var setDependencySuccess = destinationOptional
        .Value
  ...
  public ReactiveCommand<(int sourceId, int destinationId, string sourceFieldName, string destinationFieldName), Unit> Connect { get; }
